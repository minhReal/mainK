(() => {
  ...
  dragItem.innerHTML = `
    ...
    <button id="runBtn" style="width:100%;margin-top:10px;padding:10px;border:none;border-radius:5px;background:#1abc9c;color:white;font-size:16px;cursor:pointer;">Run Auto H5P</button>
  `;
